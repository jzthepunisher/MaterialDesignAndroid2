...
public class ComponentesBasciosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_componentes_bascios);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(ComponentesBasciosActivity.this, "FAB Clicked", Toast.LENGTH_SHORT).show();
            }
        });
    }
